...
function getRecetasHTML() {
    return '<div class="fade-in"><h1 class="text-3xl font-bold text-gray-800 mb-6"><i class="fas fa-book text-pagoa-green mr-3"></i>Recetas</h1><p class="text-gray-600">Módulo en construcción...</p></div>';
}
